...
const WORDS = ["Network & Telecom Student", "Backend is my playground"];
const TECH_STACK = ["Java", "SQL", "Servlet", "DSA"];

const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/karan-coder-hub" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/karan-kashyap111/" },
  { icon: Instagram, link: "https://www.instagram.com/k4_krn_kashyap/" },
];
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center h-screen md:justify-between gap-12 lg:gap-20">
            ...
            <div className="w-full lg:w-1/2 space-y-8" data-aos="fade-right">
              ...
              <p className="text-base md:text-lg text-gray-400 max-w-xl">
                Passionate backend developer turning ideas into efficient,
            ...
            {/* Right Section - GIF */}
            <div
              className="w-full lg:w-1/2 h-auto lg:h-[300px] xl:h-[200px] flex items-center justify-center"
